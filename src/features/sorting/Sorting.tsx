    ...
    >
      ...
      <FormControl error={!selectedMetric}>
        <Autocomplete
          ...
          options={availableMetrics.toSorted((a: Metric, b: Metric) =>
        ...
        <Box sx={{ paddingBottom: 0.5, paddingTop: 0.5 }}>
          <Typography level="body-lg" component="span">
            ...
            >
              <Button
                value="asc"
                endDecorator={<NorthIcon sx={{ p: 0, m: 0, fontSize: "sm" }} />}
              >
                {width < 500 ? "ASC" : "ASCENDING"}
              </Button>
              <Button
                value="desc"
                endDecorator={<SouthIcon sx={{ p: 0, m: 0, fontSize: "sm" }} />}
              >
                {width < 500 ? "DESC" : "DESCENDING"}
              </Button>
            </ToggleButtonGroup>
            order.
          </Typography>
