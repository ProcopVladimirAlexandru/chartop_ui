  ...
  return (
    <Card sx={{ m: 2, borderColor: "#ff9d25" }}>
      ...
      <Typography level="body-md" sx={{ pb: 0, mb: 0 }}>
        For a tailored Chartop deployment that reveals the most interesting
        aspects of your data, please reach out at:
      </Typography>
      <List sx={{ pt: 0, mt: 0 }}>
        ...
        <ListItem>
          ...
          <ListItemContent>
            <Link href="mailto:chartop@protonmail.com" underline="hover">
              chartop-app@protonmail.com
            </Link>
          </ListItemContent>
        </ListItem>
      </List>
      <Typography level="body-md" sx={{ pb: 0, mb: 0 }}>
        Any questions regarding the web application, API or dataset are also
        welcome.<br></br>
        Thank you!
      </Typography>
    </Card>
